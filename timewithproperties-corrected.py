...
wake_up = Time(hour=6, minute=30, second=0)
print(f'wake_up: {wake_up}')
print(f'wake_up.hour: {wake_up.hour}')
# setting to a new time
wake_up.set_time(hour=7, minute=45, second=0)
print(f'wake_up: {wake_up}')
# reassigning just the hour
wake_up.hour = 6
print(f'wake_up: {wake_up}')
