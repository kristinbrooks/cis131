"""
    script: telephone-number-word-generator2.py
    action: gets a 7-digit phone number and generates every possible 7-letter word combination corresponding to that
        number and writes the results to a file
...
with open('possible_words.txt', mode='w') as words_file:
